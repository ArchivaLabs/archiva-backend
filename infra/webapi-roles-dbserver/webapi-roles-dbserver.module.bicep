...
resource script_dbserver_ArchivaDb 'Microsoft.Resources/deploymentScripts@2023-08-01' = {
  name: take('script-${uniqueString('dbserver', principalName, 'ArchivaDb', resourceGroup().id)}', 24)
  location: location
  identity: {
    type: 'UserAssigned'
